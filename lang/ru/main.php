...
руководителями студии KUDRIASTUDIO. Мы пришли к
...
рождается атмосфера и настроение свадебного фильма.",
    ...
    'wm-desc' => "Видеозапись до<span>12 часов</span> Работает
                <span>2 оператора</span> <br />
                Видео редактируется <span> (10-20 минут) Тизер 1-2 минуты</span><br />
                <span>Авторская цветокоррекция</span> и
                <span>Звуковой дизайн</span> <br />
    ...
    'contact-desc' => "“Мы и мечтать не могли о более волшебном дне свадьбы, и это все
            спасибо Kudryastudio! От первоначальной консультации до окончательной
            команда видеомонтажеров была профессиональной, внимательной и невероятно
            талантливый. Они прекрасно запечатлели каждый особенный момент, заставив нас
            чувствуйте себя непринужденно на протяжении всего процесса. Итоговое видео превысило
            наши ожидания оправдались, и мы очень рады, что у нас такой замечательный
            подарок на память, чтобы вновь пережить день нашей свадьбы. Спасибо вам, Kudryastudio, за
            так прекрасно сохраняя наши воспоминания!”",
